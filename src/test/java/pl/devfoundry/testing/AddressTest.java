...
class AddressTest {
    ...
    void givenAddressesShouldNotBeEmptyAndHaveProperNams(String street, String number) {
    ...
    void addressesFromFileShouldNotBeEmptyAndHaveProperNams(String street, String number) {
        assertThat(street, notNullValue());
        assertThat(street, containsString("a"));
        assertThat(number, notNullValue());
        assertThat(number.length(), lessThan(8));
